...
INSERT INTO `flyway_schema_history` VALUES (1,'1.0','moopoint','SQL','V1.0__moopoint.sql',789107161,'root','2023-08-06 06:54:21',5422,1);
...
CREATE TABLE `patient` (
  ...
  `cost` int NOT NULL,
  `subject` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `rec_book` int NOT NULL,
  `booktime` date NOT NULL,
  `state` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `noon` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `recepit_id` int NOT NULL,
...
-- Dump completed on 2023-08-07 15:14:04
